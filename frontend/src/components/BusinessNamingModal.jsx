        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5">
          <div className="space-y-2">
            <p className="text-xs font-mono text-neutral-500 dark:text-neutral-400">
              Tebrikler! <strong className="text-neutral-900 dark:text-white">#{activeBusinessNaming.propertyId} - {activeBusinessNaming.propertyName}</strong> mülkünü portföyünüze eklediniz. İşletmenizin holding tabelasını asın:
            </p>
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-700 hover:border-emerald-400 dark:hover:border-emerald-500 focus:border-emerald-500 dark:focus:border-emerald-400 rounded-xl p-3.5 pl-4 pr-10 text-sm text-neutral-900 dark:text-white font-mono placeholder-neutral-400 dark:placeholder-neutral-600 focus:outline-none focus:ring-1 focus:ring-emerald-400 dark:focus:ring-emerald-500 transition-all"
              />
              <div className="absolute right-3.5 top-1/2 -translate-y-1/2 text-emerald-500 dark:text-emerald-400">
