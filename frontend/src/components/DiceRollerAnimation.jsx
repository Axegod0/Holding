...
export default function DiceRollerAnimation() {
  ...
  // Modal kontrolleri zar animasyonunu engellememeli, bu yüzden hasModalOpen kaldırıldı.
  ...
  return (
    <div className="fixed inset-0 z-[60] flex items-center justify-center bg-black/75 backdrop-blur-md p-4 animate-in fade-in duration-200 pointer-events-none">
      <div className="p-8 rounded-3xl border-2 max-w-md w-full shadow-2xl flex flex-col items-center justify-center text-center relative overflow-hidden pointer-events-auto transition-all duration-300 bg-white dark:bg-[#1c1c1e] border-emerald-500 dark:border-emerald-500/80 text-neutral-900 dark:text-white shadow-emerald-500/20 dark:shadow-emerald-500/30">
        ...
        <div className="flex items-center gap-2 px-3.5 py-1 rounded-full bg-emerald-50 dark:bg-emerald-500/15 border border-emerald-200 dark:border-emerald-500/30 text-emerald-600 dark:text-emerald-400 font-mono text-xs font-bold uppercase tracking-wider mb-4">
        ...
        <h3 className="text-xl sm:text-2xl font-black mb-6 tracking-wide">
          <span className="text-emerald-600 dark:text-emerald-400 font-extrabold">{playerName}</span> Zar Atıyor...
        </h3>
        ...
        {/* Sonuç Özeti */}
        <div className="mt-6 pt-4 border-t border-neutral-200 dark:border-neutral-800/60 w-full flex flex-col items-center min-h-[70px] justify-center">
          {isSettled ? (
            <div className="animate-in zoom-in-90 duration-300">
              ...
              {isDouble && (
                <div className="mt-2 px-4 py-1 rounded-full bg-amber-50 dark:bg-amber-500/20 border border-amber-200 dark:border-amber-500/40 text-amber-600 dark:text-amber-400 font-mono font-bold text-xs uppercase tracking-widest animate-pulse">
                  ⚡ ÇİFT ZAR! TEKRAR OYNAMA HAKKI ⚡
                </div>
              )}
            </div>
          ) : (
            <div className="text-sm font-mono font-bold text-neutral-500 dark:text-neutral-400 animate-pulse">
