        ...
        {isDrawer ? (
          ...
          <div className="flex flex-col items-center justify-center py-8 text-center space-y-4">
            ...
            <p className="text-sm font-mono text-neutral-500 dark:text-neutral-400">
              {activeChanceCard?.drawerName || 'Rakibiniz'} kartın içeriğini okuyor ve karar veriyor...<br/>
              <span className="text-[10px] mt-2 block">Karar sonucu gazete manşeti olarak düşecektir.</span>
            </p>
          </div>
        )}
      </div>
